...
public class signuptwo extends JFrame implements ActionListener{
    ...
    signuptwo(String formno) {
        ...
        String occupationalValues[] = {"Salaried" , "Self-Employed" , "Bussinessmen" , "Student" ,"Retired" , "others"};
       ...
       add(syes);
        ...
        ButtonGroup esenior_citizen = new ButtonGroup();
        esenior_citizen.add(eyes);
        esenior_citizen.add(eno);
